    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
      <div className="bg-[#18181b] text-white p-6 rounded-2xl w-[400px] shadow-lg">
        <div className="flex justify-between items-center">
          <h2 className="text-lg font-semibold">Fund wallet via card</h2>
        ...
        <select
          ...
          >
            <option value="" className="text-nfcWhite text-xs">Card type</option>
            <option value="bank1" className="text-nfcWhite text-xs">Card 1</option>
            <option value="bank2" className="text-nfcWhite text-xs">Card 2</option>
            <option value="bank3" className="text-nfcWhite text-xs">Card 3</option>
          </select>
          <input
            type="text"
